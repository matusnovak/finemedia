...
///=============================================================================
ffw::BmpSaver::BmpSaver(const std::string& path, int w, int h, ffw::ImageType type, int quality, int mips):pixelsOffset(0){
...
///=============================================================================
void ffw::BmpSaver::open(const std::string& path, int w, int h, ffw::ImageType type, int quality, int mips){
    (void)quality;
    (void)mips;
